...
const int IMPULSE_23			= 23;			// toggle midterm inventory
...
const int IMPULSE_111			= 111;			// Upgrade damage
const int IMPULSE_112			= 112;			// Upgrade speed
const int IMPULSE_113			= 113;			// Upgrade Max Health
const int IMPULSE_114			= 114;			// Upgrade regen
const int IMPULSE_115			= 115;			// Upgrade clip size
